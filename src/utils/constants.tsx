...
export const subGroups: SubGroups = {
  ...
  everything_for_plants: [
    ...
    { label: 'garden_vacuum', sr_RS: 'Baštenska usisivač' },
    { label: 'pole_saw', sr_RS: 'Pila na motki' },
    { label: 'power_rake', sr_RS: 'Motorne grablje' },
    ...
    { label: 'axe', sr_RS: 'Sekira' },
    { label: 'splitting_maul', sr_RS: 'Klin za cepanje drva' },
    ...
    { label: 'rotary_mower', sr_RS: 'Rotaciona kosa' },
    ...
    { label: 'billhook', sr_RS: 'Krivac' },
    { label: 'pickaxe', sr_RS: 'Pijuk' },
    { label: 'hatchet', sr_RS: 'Mala sekira' },
    ...
    { label: 'edging_tool', sr_RS: 'Alat za ivice travnjaka' },
