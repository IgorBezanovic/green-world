import { BraintreeCardPayment } from '@green-world/components/BraintreeCardPayment';
import {
      ...
      <DialogContent sx={{ pt: 8, p: '10px' }}>
        ...
        <Box sx={{ mb: 2 }}>
          ...
          <BraintreeCardPayment
            ...
            isValid={isValid}
            disabled={loading}
            onSuccess={() => setStatus('✅ Hvala! Donacija je uspešna.')}
            onError={(error) => setBraintreeError(error)}
          />
        </Box>
