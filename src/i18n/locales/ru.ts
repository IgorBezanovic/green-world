export const ru = {
  ...
  writePost: {
    ...
    contentDesc:
      'Создавайте контент, добавляя блоки текста и изображений. Вы можете изменить их порядок стрелками или удалить. Каждый текстовый блок имеет богатый редактор с форматированием.',
