export const ru = {
  ...
  createEditProduct: {
    ...
    ai: {
      ...
      manualOrAiTitle: 'Сначала добавьте изображение товара',
      manualOrAiHint:
        'После добавления первого изображения вы можете нажать "Заполнить остальные поля с помощью AI" или заполнить форму вручную.',
