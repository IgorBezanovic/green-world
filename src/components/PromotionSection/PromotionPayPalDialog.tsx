...
export const PromotionPayPalDialog = ({
  ...
  const [lastOrderAmountRsd, setLastOrderAmountRsd] = useState<number | null>(
    null
  );
  ...
  const handleCreateOrder = async (): Promise<string> => {
    ...
    if (typeof out.amountRsd === 'number') setLastOrderAmountRsd(out.amountRsd);
    return out.id;
  };
      ...
      <DialogContent sx={{ pt: 1, p: '10px' }}>
        ...
        {!user?._id ? (
          ...
          <>
            ...
            {canPay && (
              <Box sx={{ mt: 1 }}>
                {lastOrderAmountRsd != null && (
                  <>
                    <Typography variant="subtitle2" sx={{ mb: 0.5 }}>
                      Ukupno:{' '}
                      <strong>
                        {lastOrderAmountRsd.toLocaleString('sr-RS')} RSD
                      </strong>
                    </Typography>
                    <Typography
                      variant="caption"
                    ...
                    >
                      Na dugmetu „Pay” iznos je u EUR — PayPal prikazuje samo
                      podržane valute.
                    </Typography>
                  </>
                )}
